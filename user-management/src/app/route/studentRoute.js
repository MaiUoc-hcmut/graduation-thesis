...
router
  ...
  .put(Authorize.protectedAPI, StudentController.changePassword);
router.route('/forgot-password').post(StudentController.forgotPassword);
router
  .route('/reset-password/:resetToken')
  .put(StudentController.resetPassword);
router
  .route('/upload-avatar/:studentId')
  .post(Authorize.protectedAPI, Photo.upload, StudentController.uploadAvatar);
